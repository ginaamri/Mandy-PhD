...
The experimenter used time cards to indicate the time remaining (yellow = one minute remaining; red = time expired).

A mobile eye-tracker recorded the subject's gaze behavior and audio data of the lesson. All other sounds and voices were recorded by an audio recorder. To record facial expressions, gestures and movements, four mobile cameras were installed to record the classroom from all perspectives (!!!see figures). After the micro-teaching-unit, the teacher conducted a letter search in the room. For this, four letters had to be found in order and read aloud. This served as a control condition for the speed of the subjects' perceptual ability.

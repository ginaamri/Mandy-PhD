...
### Data collection
For the pilot study, we collected questionnaire data from N = `r sum(n_distinct(raw.data$personID))` subjects in `r sum(n_distinct(raw.data$session))` sessions. The questionnaires were answered after each lesson (10min) by an observer, the teacher and the three teachers acting as the class. 

...
(ref:data_collection-caption) Example for the set up during a mini-lesson
...
(5) Presence: posture and gaze
```{r Presence: posture and gaze line plots, fig.width=6, fig.height = 6, message = FALSE, warning = FALSE , echo=FALSE}
...
pv.data <- quest.raw.data %>% filter(scale == "Presence: posture/gaze")
...
pvni.data <- quest.raw.data %>% filter(scale == "Presence: posture/gaze")
...
nb.data <- quest.raw.data %>% filter(scale == "Presence: posture/gaze")

...
et.raw.table <- et.raw.data %>%
  ...
  summarise("Fixation Number" = Number_of_whole_fixations,
            "Average Duration Fixation" = Average_duration_of_whole_fixations,
            "SE Duration Fixation" = se(Total_duration_of_whole_fixations),
            "TOI length" = TOI,
...
```{r boxplot GRI, fig.width=6, fig.height = 8, echo = FALSE}

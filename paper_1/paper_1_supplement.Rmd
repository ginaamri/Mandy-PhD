...
After each mini-lesson, the subjects answered items on the teaching quality using a validated questionnaire ((@helmke2014unterrichtsdiagnostik)) and scales on the teacher's presence behavior. An external observer also completed the questionnaire. In addition, the teacher was asked to give a self-assessment on his/her classroom management by completing the questionnaire. 

...
(ref:data_collection-caption) Illustration of comic material that made the second author of this paper chuckle a bit. For advice on how to insert images, please see the code chunk.

```{r data collection, fig.cap = "(ref:data_collection-caption)", fig.align = "center", echo = FALSE}
...
In addition, we plotted all scales for experts and novices. Graph provides boxplots and individual data for both groups.

```{r boxplot scales, echo = FALSE}
# prepare data (selected from questionnaire data)
quest.raw.data<-read.table("./data/short_questionnaire_data_2701211.txt", dec=",", sep="\t", header=T) 
...
(ref:boxplot_all_scales-caption) Boxplot with individual points for all scales

```{r boxplot_all_scales, fig.cap = "(ref:boxplot_all_scales-caption)", fig.align = "center", echo = FALSE}

knitr::include_graphics("./pictures/boxplot_all_scales.png", dpi = 108)

```

In addition, we evaluated the duration of the speaking time during the lesson in the questionnaire by external and self-assessment. The following graph shows the duration of speaking time for experts and novices.

```{r duration speaking time, echo = FALSE}
# prepare data (selected from questionnaire data)
quest.raw.data<-read.table("./data/short_questionnaire_data_2701211.txt", dec=",", sep="\t", header=T) 

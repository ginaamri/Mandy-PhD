...
\begin{tabular}{lllll}
\toprule
scale & \multicolumn{1}{c}{M scale} & \multicolumn{1}{c}{SD scale} & \multicolumn{1}{c}{min scale} & \multicolumn{1}{c}{max sclae}\\
\midrule
Activation and support & 2.45 & 1.37 & 0.00 & 4.00\\
Clarity and structuredness & 3.41 & 0.81 & 1.00 & 4.00\\
Classroom management & 2.97 & 0.94 & 1.00 & 4.00\\
Natural behaviour & 3.28 & 0.74 & 2.00 & 4.00\\
Positive climate and motivation & 3.27 & 0.89 & 0.00 & 4.00\\
Presence: posture/gaze & 3.10 & 0.96 & 0.00 & 4.00\\
Presence: verbal and non-verbal intervention & 3.07 & 0.82 & 1.00 & 4.00\\
Presence: voice & 3.40 & 0.72 & 2.00 & 4.00\\
\bottomrule
\end{tabular}
...
\item
  Classroom management
  \includegraphics{paper_1_supplement_new_table_files/figure-latex/classroom management line plots-1.pdf}
  \newpage
\item
  Positive climate and motivation

...
quest.raw.data<-read.table("./data/short_questionnaire_data_2101211.txt",sep="\t", header=T) 
...
demo.quest.table <- quest.raw.data %>%
  ...
  summarise(N=n(),
            ...
            # "experience" = round(mean(experience), 2) # in order for this to work experience must be turned into integer via as.integer, maybe replace , with .
            )
